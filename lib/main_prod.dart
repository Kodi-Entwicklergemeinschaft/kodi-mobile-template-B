...
import 'package:your_app_name/src/firebase_options_production/firebase_options_production.dart';
...
Future<void> main() async {
  ...
  await FirebaseMessagingService(globalNavKeyProd, prefBox).initNotifications();
...
final globalNavKeyProd = GlobalKey<NavigatorState>();
