...
import 'package:your_app_name/src/presentation/cubit/authentication/authentication_cubit.dart';
import 'package:your_app_name/src/presentation/cubit/user/user_cubit.dart';
import 'package:your_app_name/src/presentation/main/account/account_profile/cubit/account_cubit.dart';
import 'package:your_app_name/src/presentation/main/account/change_password/cubit/change_password_cubit.dart';
import 'package:your_app_name/src/presentation/main/account/contact_us/cubit/contact_us_cubit.dart';
...
import 'package:your_app_name/src/presentation/main/account/edit_profile/cubit/edit_profile_cubit.dart';
...
import 'package:your_app_name/src/presentation/main/discovery/cubit/discovery_cubit.dart';
import 'package:your_app_name/src/presentation/main/home/home_screen/cubit/home_cubit.dart';
import 'package:your_app_name/src/presentation/main/home/list_product/cubit/cubit.dart';
import 'package:your_app_name/src/presentation/main/home/product_detail/cubit/cubit.dart';
import 'package:your_app_name/src/presentation/main/login/forgot_password/cubit/forgot_password_cubit.dart';
import 'package:your_app_name/src/presentation/main/login/signin/cubit/login_cubit.dart';
import 'package:your_app_name/src/presentation/main/login/signup/cubit/signup_cubit.dart';
import 'package:your_app_name/src/presentation/main/wishlist/cubit/cubit.dart';
...
class AppBloc {
  ...
  static final notificationSettingsCubit = NotificationSettingsCubit();
