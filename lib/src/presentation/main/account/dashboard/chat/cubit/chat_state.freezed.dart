    ...
    return _then(_$ChatStateLoadedImpl(
      ...
      freezed == replyMessage
          ...
          : replyMessage // ignore: cast_nullable_to_non_nullable
              as ChatMessageModel?,
      null == isSendingMessages
          ? _value.isSendingMessages
          : isSendingMessages // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
}
...
class _$ChatStateLoadedImpl implements ChatStateLoaded {
  ...
  @override
  String toString() {
    return 'ChatState.loaded(chatMessages: $chatMessages, forumDetails: $forumDetails, isAdmin: $isAdmin, userId: $userId, userName: $userName, isLoadingMore: $isLoadingMore, replyMessage: $replyMessage, isSendingMessages: $isSendingMessages)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isSendingMessages, isSendingMessages) ||
                other.isSendingMessages == isSendingMessages));
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(chatMessages, forumDetails, isAdmin, userId, userName,
        isLoadingMore, replyMessage, isSendingMessages);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(chatMessages, forumDetails, isAdmin, userId, userName,
        isLoadingMore, replyMessage, isSendingMessages);
  }
...
abstract class ChatStateLoaded implements ChatState {
  const factory ChatStateLoaded(
      ...
      final bool isLoadingMore,
      final ChatMessageModel? replyMessage,
      final bool isSendingMessages) = _$ChatStateLoadedImpl;
