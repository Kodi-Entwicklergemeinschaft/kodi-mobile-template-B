...
mixin _$AllRequestsState {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<ProductModel> recent, bool isRefreshLoader,
            PostStatusType selectedStatus)?
        loaded,
  }) =>
      throw _privateConstructorUsedError;
...
class _$AllRequestsStateLoadedImpl implements AllRequestsStateLoaded {
  const _$AllRequestsStateLoadedImpl(final List<ProductModel> recent,
      this.isRefreshLoader, this.selectedStatus)
      : _recent = recent;
  ...
  @override
  String toString() {
    return 'AllRequestsState.loaded(recent: $recent, isRefreshLoader: $isRefreshLoader, selectedStatus: $selectedStatus)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(recent, isRefreshLoader, selectedStatus);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(recent, isRefreshLoader, selectedStatus);
  }
...
abstract class AllRequestsStateLoaded implements AllRequestsState {
  const factory AllRequestsStateLoaded(
      ...
      final bool isRefreshLoader,
      final PostStatusType selectedStatus) = _$AllRequestsStateLoadedImpl;

  List<ProductModel> get recent;
  bool get isRefreshLoader;
  PostStatusType get selectedStatus;
