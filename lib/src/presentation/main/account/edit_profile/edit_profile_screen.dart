...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  @override
  void dispose() {
    _textUNameController.dispose();
    _textFNameController.dispose();
    _textLNameController.dispose();
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(Translate.of(context).translate(
              'Are_you_sure_you_want_to_delete_this_profile_image?')),
          actions: <Widget>[
            TextButton(
              onPressed: () async {
          ...
          imageDeleted: (_) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text(Translate.of(context)
                    .translate('profile_image_deleted_successful'))));
            Navigator.pop(context);
          },
          error: (_) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content:
                    Text(Translate.of(context).translate('error_message'))));
          },
        );
      },
      child: Scaffold(
                      ...
                      children: <Widget>[
                        SizedBox(
                          ...
                          child: AppUploadImage(
                            ...
                            onDelete: (_file != null || _image != null)
                                ? () {
