...
import 'package:your_app_name/src/presentation/main/discovery/cubit/cubit.dart';
import 'package:your_app_name/src/presentation/main/home/widget/home_category_item.dart';
import 'package:your_app_name/src/presentation/main/home/widget/home_sliver_app_bar.dart';
import 'package:your_app_name/src/presentation/widget/app_category_item.dart';
            ...
            child: CustomScrollView(
              ...
              slivers: <Widget>[
                AppBarHomeSliver(
                    ...
                    selectedOption:
                        (selectedCityId > 1) ? selectedCityTitle : null,
                    expandedHeight: MediaQuery.of(context).size.height * 0.3,
                    banners: banner,
                    onSearchPressed: _searchListings,
  ...
  Future<void> _onCategory(
    ...
    if (item.id != -1) {
      if (item.id == 17) {
        ...
        await launchUrl(
            Uri.parse('https://your-wifi-portal-url.com'),
