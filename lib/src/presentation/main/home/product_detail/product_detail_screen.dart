...
import 'package:your_app_name/src/presentation/main/home/product_detail/upcoming_events.dart';
...
import 'package:your_app_name/src/presentation/widget/app_user_info.dart';
    ...
    if (product != null) {
      ...
      banner = product.pdf == ''
                            ...
                            return Builder(
                              builder: (BuildContext context) {
                                String? imageUrlString = product.sourceId ==
                                    ...
                                    ? imageUrl.logo
                                    : (product.sourceId == 3 || product.sourceId == 4) &&
                                            imageUrl.logo != null
          ...
          : RawGestureDetector(
              ...
              child: const PDF().cachedFromUrl(key: const Key("product_detail"),
                "${Application.picturesURL}${product.pdf}",
      ...
      Widget upcomingEvents = const SizedBox.shrink();
      if (product.upcomingDates != null && product.upcomingDates!.isNotEmpty) {
        upcomingEvents = UpcomingEventsWidget(
          upcomingDates: product.upcomingDates!,
        );
      }
