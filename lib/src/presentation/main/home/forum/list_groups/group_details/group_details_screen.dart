  ...
  Widget build(BuildContext context) {
    return BlocConsumer<GroupDetailsCubit, GroupDetailsState>(
      listener: (context, state) {
        ...
        loaded: (posts, item, isAdmin, userId, memberRequestCount) =>
            GroupDetailsLoaded(posts, item, isAdmin, userId, memberRequestCount),
...
class GroupDetailsLoaded extends StatefulWidget {
  ...
  const GroupDetailsLoaded(
      this.posts, this.groupModel, this.isAdmin, this.userId, this.memberRequestCount,
      {super.key});
