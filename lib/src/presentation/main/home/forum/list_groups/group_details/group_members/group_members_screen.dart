...
import 'package:your_app_name/src/presentation/main/home/forum/list_groups/group_details/group_members/cubit/group_members_state.dart';
...
class _GroupMembersScreenState extends State<GroupMembersScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<GroupMembersCubit, GroupMembersState>(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        if(widget.membersList![index].joinedAt!=null)
                          Text(
                      ...
                      onSelected: (String choice) async {
                        if (choice ==
                          ...
                          await context
                              ...
                              widget.membersList?[index].memberId,widget.membersList?[index].userId);
                          if (!mounted) return;
                          context.read<GroupMembersCubit>().onLoad();
                        }
                      },
