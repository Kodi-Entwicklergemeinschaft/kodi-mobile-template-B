...
import 'package:your_app_name/src/utils/color.dart';
import 'package:your_app_name/src/utils/icon.dart';
...
class CategoryModel {
  ...
  factory CategoryModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['taxonomy'] == 'your_app_feature') {
      categoryType = CategoryType.feature;
    }
    if (json['taxonomy'] == 'your_app_location') {
