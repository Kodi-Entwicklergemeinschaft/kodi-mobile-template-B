...
import 'package:your_app_name/src/data/model/model_file.dart';
import 'package:your_app_name/src/data/model/model_image.dart';
import 'package:your_app_name/src/data/model/model_open_time.dart';
import 'package:your_app_name/src/data/model/model_setting.dart';
import 'package:intl/intl.dart';
import 'package:location/location.dart';
import 'package:html/parser.dart';

import '../../presentation/main/home/product_detail/upcoming_events.dart';

import 'model_recurring_rule.dart';
...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json,
    ...
    List<UpcomingEvent>? upcomingDates;
    ...
    if (json['upcomingDates'] != null && json['upcomingDates'] is List) {
      upcomingDates = (json['upcomingDates'] as List)
    ...
    if ((json['sourceId'] == 3 || json['sourceId'] == 4) && json['externalId'] != null) {
    ...
    if (json['logo'] != null) {
      ...
      bool isNaN = image ==
          'https://your-storage-domain.com/DefaultimageNaN.png';
    ...
    List.from(json['recurrenceRules'] ?? []).map((item) {
      return RecurrenceRuleModel.fromJson(item);
    }).toList();

    final isRecurrence = json['isRecurrence'] == true;
