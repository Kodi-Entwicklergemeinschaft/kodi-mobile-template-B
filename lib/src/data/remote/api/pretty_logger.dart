...
//https://github.com/Milad-Akarie/pretty_dio_logger/blob/master/lib/pretty_dio_logger.dart
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    if (error) {
      if (err.type == DioExceptionType.badResponse) {
        ...
        _printBoxed(header: 'DioError ║ ${err.type}', text: err.message ?? err.toString());
      }
    }
