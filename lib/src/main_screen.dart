...
import 'package:your_app_name/src/presentation/cubit/authentication/cubit.dart';
import 'package:your_app_name/src/presentation/main/account/account_profile/account_screen.dart';
import 'package:your_app_name/src/presentation/main/discovery/discovery_screen.dart';
import 'package:your_app_name/src/presentation/main/home/home_screen/home.dart';
import 'package:your_app_name/src/presentation/main/wishlist/wishlist_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  ...
  void _listenAuthenticateChange(AuthenticationState authentication) async {
    if (authentication == const AuthenticationState.loggedOut() &&
    ...
    else if(authentication == const AuthenticationState.failed()){
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text(Translate.of(context).translate('session_expired_message'))),
      );
